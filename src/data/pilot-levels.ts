...
export const PILOT_LEVELS: PilotLevel[] = [
  {
    ...
    recommendedProductIds: [
      "navlogpro", "sportys-learn-to-fly", "foreflight",
      "mechanical-e6b", "plotter",
      "rugged-air-ra950", "david-clark-h10",
      "phak", "ipad-mini", "sportys-pilottraining-app",
    ],
    whatYouWillLearn: [
  ...
  },
  {
    ...
    recommendedProductIds: [
      ...
      "mechanical-e6b", "plotter",
      "rugged-air-ra950", "david-clark-h10",
      "phak", "ipad-mini", "sportys-flight-bag",
    ],
    whatYouWillLearn: [
  ...
  },
  {
    ...
    certificateType: "Private",
    recommendedProductIds: [
      "navlogpro", "sportys-learn-to-fly", "sportys-checkride-prep",
      "mechanical-e6b", "plotter",
      "rugged-air-ra950", "david-clark-h10",
      "foreflight", "ipad-mini", "ram-ipad-mount",
    ],
    whatYouWillLearn: [
  ...
  },
  {
    ...
    recommendedProductIds: [
      "navlogpro", "sportys-instrument-course", "foggles",
      "bose-a20", "david-clark-h10",
      "foreflight", "ipad-mini", "ram-ipad-mount",
      "stratus-3", "garmin-pilot",
    ],
    whatYouWillLearn: [
  ...
  },
  {
    ...
    recommendedProductIds: [
      "navlogpro", "sportys-commercial-course", "foreflight",
      "lightspeed-zulu3", "bose-a20",
      "ipad-air", "ram-ipad-mount",
      "brightline-bags", "stratus-3", "maui-jim-sunglasses",
    ],
    whatYouWillLearn: [
  ...
  },
  {
    ...
    certificateType: "CFI",
    recommendedProductIds: [
      "navlogpro", "sportys-cfi-course", "foreflight",
      "bose-a30", "lightspeed-zulu3",
      "ipad-air", "ram-ipad-mount",
      "stratus-3", "brightline-bags", "maui-jim-sunglasses",
    ],
    whatYouWillLearn: [
  ...
  },
  {
    ...
    recommendedProductIds: [
      ...
      "ipad-air", "ram-ipad-mount",
      "stratus-3", "brightline-bags",
      "maui-jim-sunglasses", "oakley-aviator",
    ],
    whatYouWillLearn: [
