...
export const metadata: Metadata = {
  ...
  description: "Terms of Service for I Want To Be A Pilot.",
      ...
      <div className="space-y-8 text-sm leading-relaxed">
        ...
        <section>
          ...
          <ul className="space-y-2 text-muted-foreground list-disc list-inside">
            ...
            <li><strong className="text-foreground">Refunds:</strong> We offer refunds at our sole discretion. Contact support@iwanttobeapilot.online within 7 days of a charge if you believe a refund is warranted.</li>
