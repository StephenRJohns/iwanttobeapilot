...
export default function PARPracticeSessionPage() {
  return (
    <Suspense fallback={
      ...
      <PARPracticeSessionInner />
    </Suspense>
  );
}

function PARPracticeSessionInner() {
  ...
  if (error) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <button
          onClick={() => router.push("/par-practice")}
          className="mt-4 text-sm text-primary hover:underline"
        >
          ← Back to PAR Practice
        </button>
      </div>
    );
  }
